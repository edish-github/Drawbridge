    ...
    <>
      ...
      <div className="scroll-area" style={{ animation: "db-rise 260ms ease both" }}>
        <div className="notice" style={{ marginBottom: 18 }}>
          <strong style={{ color: "var(--ink)" }}>Read-only, deliberately.</strong> Policy lives in
          version control, not in a form: a change to the rubric is a diff somebody reviewed, and
          the plan version it produces is recorded in every affected binder. Editing scoring from
          a console every reviewer can reach would make the number a preference rather than an
          argument.
        </div>
